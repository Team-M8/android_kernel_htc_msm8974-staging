...
static const short liteon_otp_addr[3][LITEON_OTP_SIZE] = {
...
static const short ois_addr[3][LITEON_OIS_OTP_SIZE] = {
	...
	struct msm_sensor_ctrl_t *s_ctrl, bool first, uint8_t valid_layer)
{
    ...
    static const short sharp_otp_addr[SHARP_OTP_LAYER][SHARP_OTP_SIZE] = {
    ...
    static const short sharp_fuseid_addr[SHARP_FUSEID_SIZE]={0x3f4,0x3f5,0x3f6,0x3f7,0x3f8,0x3f9,0x3fa,0x3fb,0x3fc,0x3fd,0x3fe,0x3ff};
